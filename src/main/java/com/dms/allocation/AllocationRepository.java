...
public interface AllocationRepository extends JpaRepository<Allocation, Long> {
    @EntityGraph(attributePaths = {"supervisor","supervisor.user","coSupervisor","coSupervisor.user","topic"})
    ...
    @EntityGraph(attributePaths = {"student","student.user","supervisor","supervisor.user","coSupervisor","coSupervisor.user","topic"})
    List<Allocation> findBySessionOrderByRequestedAtDesc(AcademicSession session);
    @EntityGraph(attributePaths = {"student","student.user","supervisor","supervisor.user","coSupervisor","coSupervisor.user","session","topic"})
